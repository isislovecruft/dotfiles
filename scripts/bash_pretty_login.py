...
class GreetingsEarthling:
    ...
    def its_an_art():
        ...
        greetings.append("""
             ...
             .?'           _QQP?                                WQQ.aa            QQQ  
    QQaQQ;   ]QQ jQQQQ    ]QQQQQ _yQQQQa QQ6mQf   ]QQyQQ_jQQQQa WQQQQWQ/ _yQQQQa QQQQQk
    QQQQW    ]QQ]QQE?4    )9QQP? QQW?4QQrWQQQQ'   ]QQQQfQQW?4QQrWQQ??QQQ.QQQ?4QQ[?QQQ?^
    QQP      ]QQ QQQQw     =QQf ]QQf  QQfBQQ      ]QQf ]QQf  QQfWWQ. ]QQfWQf  QQk QQQ  
    ...
    @@@@@@@@@@@@@@@@@@@@@@OOc::.::...cCo.o... ..:..:.:::8@@@@@@@@@@@@@@@@@@@@@@@@@@
    @@@@@@@@@@@@@@@@@@@@@OCccocc...::.cc:.....c....Cc::O@@@@@@@@@@@@@@@@@@@@@@@@@@@
    @@@@@@@@@@@@@@@@@@@@8Coco:o:..oocc::o::oc::.:ccc:oO@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    @@@@@@@@@@@@@@@@@@@@OCCCCoocoCcccoCo:o:o:c...ccco8@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    @@@@@@@@@@@@@@@@@@@@@@@@8CoCooccCCcOc::c:.cccO@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@OoocC::c:oOoO@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ooooccCoC.o8@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@CCCCocOO8@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@OOCo::COCC@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@88@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@""")
        '''
        #ascii_art = choice(greetings)
        #ascii_art_fixed = r'%s' % ascii_art
        #return ascii_art_fixed
        return greetings
